...
In another terminal run: ollama pull deepseek-r1:8b
...
def make_question(question: str, question_type: QuestionType) -> str:
    ...
    return get_deepseek_answer(promt)
...
def eval_answer(answer: str, question_type: QuestionType, expected_answer: str) -> bool:
    ...
    answer = get_deepseek_answer(promt)
...
if __name__ == "__main__":
    ...
    answers_df.to_csv('./results/deepseek-r1-8b_answers_eval.csv', index=False)
